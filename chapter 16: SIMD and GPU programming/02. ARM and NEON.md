...
- For a hands-on ARM NEON project with working examples, see the Cactus compute library: [github.com/cactus-compute/cactus](https://github.com/cactus-compute/cactus).
